import 'package:event2025/features/auth/controllers/auth_controller.dart';
...
import './menu_screens/billing_details_screen.dart';
import './menu_screens/information_screen.dart';
import './menu_screens/user_management_screen.dart';
        ...
        child: Obx(() {
          ...
          return Column(
            children: [
              ...
              Text(user.phoneNo, style: Theme.of(context).textTheme.bodyMedium),
